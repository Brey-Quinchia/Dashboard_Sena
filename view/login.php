...
<head>
    ...
    <link rel="shortcut icon" href="assets/img/login.png" type="image/x-icon">
            ...
            <div class="row full-height justify-content-center">
                <div class="col-12 text-center align-self-center py-5">
                    <div class="section pb-5 pt-5 pt-sm-2 text-center">
                        <h6 class="mb-0 pb-3"><span>Log In </span>or<span>Sign Up</span></h6>
                                ...
                                <div class="card-front">
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            <h3 class="mb-1 pb-2">Tracking System</h3>
                                ...
                                <div class="card-back">
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="logname" class="form-style" placeholder="Nombre Completo" id="signname" autocomplete="off">
                                                <i class="input-icon bi-rocket-takeoff-fill"></i>
                                                <!-- <i class="input-icon uil uil-user"></i> -->
                                            </div>
                                            <div class="form-group mt-2">
                                                <input type="email" name="logemail" class="form-style" placeholder="Email" id="signemail" autocomplete="off">
                                                <!-- <i class="input-icon uil uil-at"></i> -->
                                                <i class="input-icon bi bi-at"></i><!--Link for Bootstrap -->
                                            </div>
                                            <div class="form-group mt-2">
                                                <input type="password" name="logpass" class="form-style" placeholder="Contraseña" id="signpass" autocomplete="off">
                                                <i class="input-icon bi bi-person-lock"></i>
                                                <!-- <i class="input-icon uil uil-lock-alt"></i> -->
                                            </div>
